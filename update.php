...
<head>
    ...
    <!-- Favicons -->
    <link rel="icon" type="image/png" href="<?= BASE_URL ?>/image/favicon-96x96.png" sizes="96x96" />
    <link rel="icon" type="image/png" href="<?= BASE_URL ?>/image/web-app-manifest-192x192.png" sizes="192x192" />
    <link rel="icon" type="image/png" href="<?= BASE_URL ?>/image/web-app-manifest-512x512.png" sizes="512x512" />
    <link rel="icon" type="image/svg+xml" href="<?= BASE_URL ?>/image/favicon.svg" />
